...
// 2. Написать метод «Шифр Цезаря», с булевым параметром зашифрования и расшифро- вания и числовым ключом;
     ...
     * arrayFrequenceDifference - промежуточный, частотный массив,
     ...
     * вторым циклом перебираем входной массив в обратном порядке, для каждого значения которого
     *                правильный индекс в выходном массиве соответ значению в частотном массиве
     *                по индексу равному данному значению
